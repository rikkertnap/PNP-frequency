...
def compute_release_components(freq, k, params):
    ...
    #u_A = np.array([-alpha_A, -a_A, B_A, 0]) # wrong order !!
    # coefficient of relase from ATP and DNA 

    u_A = np.array([-a_A, -alpha_A, B_A, 0])
